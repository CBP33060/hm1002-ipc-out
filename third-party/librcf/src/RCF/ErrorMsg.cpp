...
namespace RCF
{
    ...
    std::string ErrorMsg::getLiteral() const
    {
        ...
        case 27    /*RcfError_SspiAuthFail                   */: return "SSPI authorization failed."; 
        ...
        case 106   /*RcfError_SspiAuthFailServer             */: return "Server-side SSPI authorization failed."; 
        case 107   /*RcfError_SspiAuthFailClient             */: return "Client-side SSPI authorization failed. %1%"; 
        ...
        case 160   /*RcfError_HttpSessionTimeout             */: return "HTTP session has timed out."; 
        ...
        case 165   /*RcfError_NotHttpResponse                */: return "HTTP port received a non-HTTP response."; 
        case 166   /*RcfError_NotHttpPostRequest             */: return "This HTTP port only supports HTTP POST requests."; 
        case 167   /*RcfError_NotHttpRequest                 */: return "HTTP port received a non-HTTP request."; 
        ...
        default:
            RCF_ASSERT(0 && "Invalid error message ID.");
        }
