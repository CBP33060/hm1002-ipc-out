...
public:
     ...
     */
    void setOperateMode(maix::OperateMode operateMode = maix::AsynchronousOperate);
     ...
     */
    void setFlowControl(maix::FlowControl flowControl);
    /**
     ...
     */
    maix::FlowControl getFlowControl() const;
