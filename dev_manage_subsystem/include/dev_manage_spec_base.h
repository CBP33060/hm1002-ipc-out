...
namespace maix {
	...
	#define PARA_WIFI_SIGNAL					"wifi_signal"
	#define PARA_TIMING_DECTION					"timing_detection"
	
	#define PARA_SET_NIGHT_SHOTH      			"set_night_shot" 
	#define PARA_SET_SET_WDR      				"set_wdr_mode" 
	#define PARA_SET_WATER_MARK      			"set_water_mark" 
}
