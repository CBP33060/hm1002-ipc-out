...
namespace RCF
{
    ...
    #define RcfError_SspiAuthFail                    ErrorMsg( 27) // SSPI authorization failed.
    ...
    #define RcfError_SspiAuthFailServer              ErrorMsg(106) // Server-side SSPI authorization failed.
    #define RcfError_SspiAuthFailClient              ErrorMsg(107) // Client-side SSPI authorization failed. %1%
    ...
    #define RcfError_HttpSessionTimeout              ErrorMsg(160) // HTTP session has timed out.
    ...
    #define RcfError_NotHttpResponse                 ErrorMsg(165) // HTTP port received a non-HTTP response.
    #define RcfError_NotHttpPostRequest              ErrorMsg(166) // This HTTP port only supports HTTP POST requests.
    #define RcfError_NotHttpRequest                  ErrorMsg(167) // HTTP port received a non-HTTP request.
